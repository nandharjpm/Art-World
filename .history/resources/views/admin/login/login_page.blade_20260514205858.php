        ...
        *{
        ...
        body{
            ...
            background:
                ...
                radial-gradient(circle at bottom right, #2cb67d 0%, transparent 30%),
        ...
        .form-control:focus{
            ...
            box-shadow:
                ...
                0 8px 20px rgba(127,90,240,0.15);
        }
        ...
        .login-btn{
            ...
            box-shadow:
                0 10px 25px rgba(127,90,240,0.35);
        }

        .login-btn:hover{
            transform:translateY(-3px);
            box-shadow:
                0 14px 35px rgba(127,90,240,0.45);
        }
